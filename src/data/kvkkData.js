export const kvkkText = {
    tr: {
      ...
      <h3 class="text-gold font-bold mb-2">4. Haklarınız</h3>
    ...
    en: {
        title: "Personal Data Protection Law (KVKK) Clarification Text",
        content: `
      ...
      <h3 class="text-gold font-bold mb-2">4. Your Rights</h3>
